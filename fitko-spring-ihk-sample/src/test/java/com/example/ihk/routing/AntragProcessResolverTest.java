...
class AntragProcessResolverTest {
    ...
    private static final String AACHEN_STARTER = "com.example.ihk.processstarter.impl.LoggingProcessStarter";
    private static final String HANNOVER_STARTER = "com.example.ihk.processstarter.impl.NoopProcessStarter";
    ...
    void fallsBackToTheDefaultProcessStarterClassForAnUnmappedLeistung() {
        ...
        properties.setDefaultProcessStarterClass("com.example.ihk.processstarter.impl.NoopProcessStarter");

        AntragProcessResolver resolver = new AntragProcessResolver(properties);

        assertThat(resolver.resolveProcessStarterClassName("101-aachen", UNMAPPED))
                .contains("com.example.ihk.processstarter.impl.NoopProcessStarter");
