...
public final class TestJwkKeys {
    ...
    /** A public encryption key, e.g. to put into a submission's reply channel. */
    public static JWK encryptionPublicKey() {
        return TestKeyBuilder.generateEncryptionKeyPair().getPublicKey();
    }
